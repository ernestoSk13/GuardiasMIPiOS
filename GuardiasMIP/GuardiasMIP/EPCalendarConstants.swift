...
struct EPDefaults  {
    ...
    static let weekdayTintColor = EPColors.baseColor
    static let weekendTintColor = EPColors.BlueColor
    static let dateSelectionColor = EPColors.PeterRiverColor
    static let monthTitleColor = EPColors.baseColor
...
struct EPColors{
    ...
    static let baseColor = UIColor.containerViewColor()
